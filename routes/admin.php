...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('DonationCategoryController')->prefix('donationCategory')->name('donationCategory.')->group(function () {
        Route::get('index', 'index')->name('index');
    ...
    // Success Story
    Route::controller('ManageSuccessStoryController')->prefix('success/story')->name('success.story.')->group(function () {

        Route::get('manage-content/{key}', 'FrontendController@frontendSections')->name('content');
        ...
        Route::get('success/comment', 'comment')->name('comment');
    ...
    Route::controller('ManageCampaignController')->prefix('fundrise')->name('fundrise.')->group(function () {
        ...
        Route::post('featured/{id}', 'featured')->name('make.featured');
        Route::post('approve/reject/{status}/{id}', 'approveOrReject')->name('approve.reject');
        ...
        Route::post('status/{id}', 'commentStatus')->name('comment.status');
        Route::get('update/request', 'campaignExtend')->name('update.request');
        Route::get('request/{slug}/{id}', 'extendDetails')->name('request.details');
    ...
    Route::controller('DonationController')->prefix('donation')->name('donation.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('campaign/{id}', 'campaignWiseDonations')->name('campaign.wise');
        Route::get('donors', 'donors')->name('donors');
        Route::get('readData', 'readData')->name('readData');
        
    });

    //Manage Category
    Route::controller('MangeVolunteerController')->prefix('volunteer')->name('volunteer.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('status/{id}', 'status')->name('status');
        Route::get('details/{id}', 'details')->name('details');
        Route::post('update/{id?}', 'update')->name('update');
        Route::get('email/{id}', 'formEmail')->name('email');
        Route::post('email/{id}', 'sendEmail')->name('email.send');
    });
