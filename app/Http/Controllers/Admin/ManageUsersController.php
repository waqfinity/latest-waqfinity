...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $widget['totalCampaign']        = Campaign::where('user_id', $id)->count();
        $widget['totalRunningCampaign'] = Campaign::running()->where('user_id', $id)->count();
        $widget['totalDeposit']         = Deposit::where('user_id', $user->id)->where('status', Status::PAYMENT_SUCCESS)->sum('amount');
        $widget['totalWithdrawals']     = Withdrawal::where('user_id', $user->id)->where('status', Status::PAYMENT_SUCCESS)->sum('amount');
