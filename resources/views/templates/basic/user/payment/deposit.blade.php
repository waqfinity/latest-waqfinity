                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="amount" class="form-control" value="{{ old('amount', $donation->donation) }}" autocomplete="off" readonly required>
                                ...
                                <button type="submit"  class="btn cmn-btn w-100 mt-3 submitConfirmation">@lang('Submit')</button>
