                                ...
                                @forelse($categories as $category)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline--primary editBtn cuModalBtn" data-resource="{{$category}}" data-isChecked="{{ $category->is_corporate ? 'true' : 'false' }}"   data-modal_title="@lang('Edit Page Category')" data-has_status="1">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <!--<input class="form-check-input" type="checkbox" name="is_corporate" id="checkbox">-->
                            <input class="form-check-input" type="checkbox" name="is_corporate" id="checkbox" >
                            <label>@lang('Check to mark this category as Corporate pages.')</label>
<!--                           
                            <!--{{ $category->is_corporate ? 'checked' : '' }}-->
                            <!--{{old('name')}}-->
...
<button type="button" class="btn btn-sm btn-outline--primary cuModalBtn" data-image_path="{{ getImage(getFilePath('category'),getFileSize('category')) }}" data-modal_title="@lang('Add New Page Category')">
...
@push('script')
    <script>
        $('.editBtn').on('click', function () {
            ...
            var isChecked = data['is_corporate'];
