...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $campaigns['total_campaign'] = Campaign::count();
        $campaigns['pending']        = Campaign::pending()->count();
        $campaigns['running']        = Campaign::active()->running()->inComplete()->count();
        $campaigns['comments']       = Comment::whereHas('campaign')->count();
        $success  ['stories']        = SuccessStory::count();


        $donations['total_donations']  = Donation::paid()->sum('donation');
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'report', 'depositsMonth', 'withdrawalMonth', 'donations', 'campaigns', 'success', 'months', 'trxReport', 'plusTrx', 'minusTrx'));
    }
