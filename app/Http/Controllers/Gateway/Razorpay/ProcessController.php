...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        if (auth()->check()) {
            ...
            $val['name']            = $deposit->donation->fullname;
            $val['prefill.name']    = $deposit->donation->fullname;
            $val['prefill.email']   = $deposit->donation->email;
            $val['prefill.contact'] = $deposit->donation->mobile;
        }
