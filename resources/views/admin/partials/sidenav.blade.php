            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.fundrise*', 3) }}">
                        ...
                        @if ($pendingCampaign || @$updateCampaignRequest || $campaignComments)
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.fundrise*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.index']) }}">
                                <a href="{{ route('admin.fundrise.index') }}" class="nav-link">
                            ...
                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.pending']) }}">
                                <a href="{{ route('admin.fundrise.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Campaigns')</span>
                                    @if ($pendingCampaign)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingCampaign }}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.success']) }}">
                                <a href="{{ route('admin.fundrise.success') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Successful Campaigns')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.rejected']) }}">
                                <a href="{{ route('admin.fundrise.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Campaigns')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.update.request']) }}">
                                <a href="{{ route('admin.fundrise.update.request') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Extend Campaigns')</span>

                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive(['admin.fundrise.comments']) }}">
                                <a href="{{ route('admin.fundrise.comments') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Campaign Comments')</span>
                                    @if ($campaignComments)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $campaignComments }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.volunteer.*') }}">
                    <a href="{{ route('admin.volunteer.index') }}" class="nav-link ">
                        ...
                        @if ($pendingVolunteer > 0)
                            <span class="menu-badge pill bg--danger ms-auto">{{ $pendingVolunteer }}</span>
                        @endif
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.donation.index') }}">
                    <a href="{{ route('admin.donation.index') }}" class="nav-link ">
                        <i class="menu-icon las la-wallet"></i>
                        <span class="menu-title">@lang('All Donations')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.donation.donors') }}">
                    <a href="{{ route('admin.donation.donors') }}" class="nav-link ">
                        <i class="menu-icon las la-wallet"></i>
                        <span class="menu-title">@lang('All Donors')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.donationCategory.index') }}">
                    <a href="{{ route('admin.donationCategory.index') }}" class="nav-link ">
                        <i class="menu-icon las la-wallet"></i>
                        <span class="menu-title">@lang('Donations Categories')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.success.story*', 3) }}">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.success.story*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.success.story.content') }} ">
                                <a href="{{ route('admin.success.story.content', 'success_story') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Manage Content')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.success.story.index') }} ">
                                <a href="{{ route('admin.success.story.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Stories')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.success.story.review') }} ">
                                <a href="{{ route('admin.success.story.comment') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Comments')</span>
                                    @if ($blogComments > 0)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $blogComments }}</span>
                                    @endif
                                </a>
                            </li>
                        </ul>
