                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                ...
                                <div>
                                    <p class="fw-bold mb-0">@lang('Anonymous Donation')</p>
                                    <p class="mb-0">
                                        <small>@lang("If you disable this module, no one can't give an anonymous donation")</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="anonymous_donation"
                                        @if ($general->anonymous_donation) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            ...
                            <li
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        @if ($general->multi_language) checked @endif>
                                </div>
                            </li>
