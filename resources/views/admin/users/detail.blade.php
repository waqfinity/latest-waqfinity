        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-4 col-sm-6">
                    <x-widget link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-money-bill-wave-alt" title="Balance" value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" bg="19" style="3"/>
                </div>
                <div class="col-xxl-4 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount( $widget['totalDeposit']) }}" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" icon="las la-wallet" title="Donations"  bg="primary" style="3"/>
                </div>
                <div class="col-xxl-4 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($widget['totalWithdrawals'] ) }}" link="{{ route('admin.withdraw.log') }}?search={{ $user->username }}" icon="fas fa-wallet" title="Withdraws"  bg="1" style="3"/>
                </div>
                <div class="col-xxl-4 col-sm-6">
                    <x-widget value="{{ $widget['totalTransaction'] }}" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-exchange-alt" title="Donation Transactions"  bg="17" style="3"/>
                </div>
                <div class="col-xxl-4 col-sm-6">
                    <x-widget value="{{ $widget['totalCampaign'] }}" link="{{ route('admin.fundrise.index') }}?search={{ $user->username }}" icon="las la-hand-holding-usd" title="Total Campaigns"  bg="13" style="3"/>
                </div>

                <!-- dashboard-w1 end -->
                <div class="col-xxl-4 col-sm-6">
                    <x-widget link="{{ route('admin.fundrise.running') }}?search={{ $user->username }}" icon="las la-users f-size--56" title="Running Campaigns" value="{{$widget['totalRunningCampaign']}}" bg="primary" style="3"/>
