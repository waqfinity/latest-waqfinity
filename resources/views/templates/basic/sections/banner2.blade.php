@php
    $banners = getContent('banner2.element', null, false, true);
    ...
    <div class="hero__slider">
        @foreach ($banners as $item)
            <div class="single__slide bg_img"
                data-background="{{ getImage('assets/images/frontend/banner2/' . $item->data_values->image, '1980x1280') }}">
                <div class="container">
                        ...
                        <div class="col-lg-8">
                            <div class="hero__content text-center">
                                ...
                                <div class="btn-group mt-40" data-animation="fadeInUp" data-delay=".7s">
                                    <a href="{{ @$item->data_values->button_url_one }}" class="cmn-btn">
